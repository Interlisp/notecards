...
var window_element = jQuery("#"+String(this.wid));
...
var width = parseInt(this.video.getAttribute("width"));
var height = parseInt(this.video.getAttribute("height"));
